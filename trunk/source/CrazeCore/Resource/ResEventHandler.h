...
namespace Craze
{
	...
	public:
		...
		virtual bool readComplete(std::shared_ptr<Resource> res) { return true; }
		virtual bool allComplete(std::shared_ptr<Resource> res) { return true; }

		virtual bool fileReadError(std::shared_ptr<Resource> res) { return true; }
